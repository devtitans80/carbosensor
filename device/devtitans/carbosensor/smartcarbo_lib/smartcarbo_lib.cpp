...
namespace devtitans::smartcarbo {                       // Entra no pacote devtitans::smartlamp

int Smartcarbo::connect() {
    char dirPath[] = "/sys/kernel/smartcarbo";
    struct stat dirStat;
...
int Smartcarbo::readFileValue(string file) {
